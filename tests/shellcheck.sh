...
# The  project directory is one up from this script's directory, tests/
PROJECT_DIR="$SCRIPT_DIR/.."

pushd "$PROJECT_DIR"
  # Run shellcheck against all of the `.sh` script files in the
  # project directory.
  #
