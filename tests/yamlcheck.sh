...
# specifies a custom yamllint config to adjust what rules are applied
YAMLLINT_ARGS=(-c "$SCRIPT_DIR/yamllint-config.yml")

pushd "$PROJECT_DIR"
  # Run yamllint against all of the `.yml` files in the
  # project directory.
  #
